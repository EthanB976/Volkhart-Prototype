...
public class AlienWanderCharger : MonoBehaviour
{
    ...
    [SerializeField] private AlienCharger alienCharger;
    ...
    private void Update()
    {
        ...
        if (alienCharger.isCharging || alienCharger.isPreparingCharging)
        {
            return;
        }
